...
_Tener en cuenta que se encuentra ignorado el archivo "local.py" el cual de base importa todo, importa os y contiene información de DEBUG; ALLOWED_HOSTS y DATABASES_
